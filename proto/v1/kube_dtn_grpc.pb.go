...
func (c *localClient) Get(ctx context.Context, in *PodQuery, opts ...grpc.CallOption) (*Pod, error) {
	out := new(Pod)
	err := c.cc.Invoke(ctx, "/proto.v1.Local/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) AddGRPCWireLocal(ctx context.Context, in *WireDef, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/proto.v1.Local/AddGRPCWireLocal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) RemGRPCWire(ctx context.Context, in *WireDef, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/proto.v1.Local/RemGRPCWire", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) GenerateNodeInterfaceName(ctx context.Context, in *GenerateNodeInterfaceNameRequest, opts ...grpc.CallOption) (*GenerateNodeInterfaceNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.v1.Local/GenerateNodeInterfaceName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Local_SetAlive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.Local/SetAlive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Local_GRPCWireExists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.Local/GRPCWireExists",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Local_AddGRPCWireLocal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.Local/AddGRPCWireLocal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Local_RemGRPCWire_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.Local/RemGRPCWire",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Local_GenerateNodeInterfaceName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.Local/GenerateNodeInterfaceName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Local_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/v1/kube_dtn.proto",
}
...
func (c *remoteClient) Update(ctx context.Context, in *RemotePod, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/proto.v1.Remote/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remoteClient) AddGRPCWireRemote(ctx context.Context, in *WireDef, opts ...grpc.CallOption) (*WireCreateResponse, error) {
	out := new(WireCreateResponse)
	err := c.cc.Invoke(ctx, "/proto.v1.Remote/AddGRPCWireRemote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Remote_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.Remote/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Remote_AddGRPCWireRemote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.Remote/AddGRPCWireRemote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
type VMSidecarClient interface {
	AddVMLinks(ctx context.Context, in *LinksBatchQuery, opts ...grpc.CallOption) (*BoolResponse, error)
	DelVMLinks(ctx context.Context, in *LinksBatchQuery, opts ...grpc.CallOption) (*BoolResponse, error)
	UpdateVMLinks(ctx context.Context, in *LinksBatchQuery, opts ...grpc.CallOption) (*BoolResponse, error)
}
...
func (c *vMSidecarClient) AddVMLinks(ctx context.Context, in *LinksBatchQuery, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/proto.v1.VMSidecar/AddVMLinks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMSidecarClient) DelVMLinks(ctx context.Context, in *LinksBatchQuery, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/proto.v1.VMSidecar/DelVMLinks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMSidecarClient) UpdateVMLinks(ctx context.Context, in *LinksBatchQuery, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/proto.v1.VMSidecar/UpdateVMLinks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VMSidecarServer interface {
	AddVMLinks(context.Context, *LinksBatchQuery) (*BoolResponse, error)
	DelVMLinks(context.Context, *LinksBatchQuery) (*BoolResponse, error)
	UpdateVMLinks(context.Context, *LinksBatchQuery) (*BoolResponse, error)
...
func (UnimplementedVMSidecarServer) AddVMLinks(context.Context, *LinksBatchQuery) (*BoolResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddVMLinks not implemented")
}
func (UnimplementedVMSidecarServer) DelVMLinks(context.Context, *LinksBatchQuery) (*BoolResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DelVMLinks not implemented")
}
func (UnimplementedVMSidecarServer) UpdateVMLinks(context.Context, *LinksBatchQuery) (*BoolResponse, error) {
...
func _VMSidecar_AddVMLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.VMSidecar/AddVMLinks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VMSidecarServer).AddVMLinks(ctx, req.(*LinksBatchQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _VMSidecar_DelVMLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.VMSidecar/DelVMLinks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VMSidecarServer).DelVMLinks(ctx, req.(*LinksBatchQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _VMSidecar_UpdateVMLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.VMSidecar/UpdateVMLinks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VMSidecarServer).UpdateVMLinks(ctx, req.(*LinksBatchQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VMSidecar_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.v1.VMSidecar",
...
func (c *wireProtocolClient) SendToOnce(ctx context.Context, in *Packet, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/proto.v1.WireProtocol/SendToOnce", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wireProtocolClient) SendToStream(ctx context.Context, opts ...grpc.CallOption) (WireProtocol_SendToStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &WireProtocol_ServiceDesc.Streams[0], "/proto.v1.WireProtocol/SendToStream", opts...)
	if err != nil {
		return nil, err
	}
...
func _WireProtocol_SendToOnce_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.v1.WireProtocol/SendToOnce",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var WireProtocol_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.v1.WireProtocol",
